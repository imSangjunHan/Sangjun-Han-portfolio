                ...
                {filteredPubs.map((pub) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {pub.thumbnailImage && (
                          <div className="hidden lg:flex w-36 aspect-[4/3] rounded-none overflow-hidden border border-neutral-200 shrink-0 bg-neutral-50 shadow-sm items-center justify-center">
                            <img 
